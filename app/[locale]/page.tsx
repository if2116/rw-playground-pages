...
async function PartnersCarouselSection({ locale }: { locale: string }) {
  ...
  const partners = [
    { id: '1', name: 'Yangtze Delta Region Institute', logo: withBasePath('/partners/001.png') },
    { id: '2', name: 'Tsinghua University', logo: withBasePath('/partners/002.jpg') },
    { id: '3', name: 'Shenghong', logo: withBasePath('/partners/003.png') },
    { id: '4', name: 'Bi Sheng', logo: withBasePath('/partners/004.png') },
    { id: '5', name: 'Ping An', logo: withBasePath('/partners/005.png') },
    { id: '6', name: 'Small and Medium Banks Alliance', logo: withBasePath('/partners/006.png') },
    { id: '7', name: 'China Southern Power Grid', logo: withBasePath('/partners/007.png') },
    { id: '8', name: 'Oxford Institute for Advanced Research, Suzhou', logo: withBasePath('/partners/008.png') },
    { id: '9', name: 'OXValue.AI', logo: withBasePath('/partners/009.png') },
    { id: '10', name: 'Zhuke Digital Intelligence', logo: withBasePath('/partners/010.png') },
    { id: '11', name: 'Zhi Xiang Huan Yu', logo: withBasePath('/partners/011.jpg') },
    { id: '12', name: 'CICAS', logo: withBasePath('/partners/012.png') },
  ];
