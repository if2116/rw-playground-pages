...
```
- 创建相关服务 python 文件：
[github_server.py](https://github.com/THU-ZJAI/Real-World-AI_Source/blob/main/MCP/code_github_mcp/github_server.py)
[hf_server.py](https://github.com/THU-ZJAI/Real-World-AI_Source/blob/main/MCP/model_huggingface_mcp/hf_server.py)
[arxiv_server.py](https://github.com/THU-ZJAI/Real-World-AI_Source/blob/main/MCP/paper_arxiv_mcp/arxiv_server.py)
安装依赖并启动：
```bash
